...
export const sessions: Session[] = [
  ...
  { id: 'new-york', label: 'New York', flag: '🇺🇸', openHourGMT: 13, closeHourGMT: 22, color: 'var(--bullish)' },
  { id: 'overlap', label: 'Overlap', flag: '🔥', openHourGMT: 13, closeHourGMT: 17, color: 'var(--bearish)' },
