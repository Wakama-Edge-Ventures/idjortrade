    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
      ...
      >
        <div
          ...
          style={{ background: 'var(--bullish-muted)' }}
        />
        ...
        <div className="flex items-baseline gap-2 mb-2">
          <span className="font-data text-4xl font-bold" style={{ color: 'var(--bullish)' }}>
            +{stats.totalPnlFCFA.toLocaleString('fr-FR')}
          </span>
          <span className="text-base" style={{ color: 'var(--text-secondary)' }}>FCFA</span>
        </div>
        {/* Mini sparkline */}
        <svg width="120" height="30" viewBox="0 0 120 30" className="mb-2">
          ...
          <path
            ...
            fill="none" stroke="var(--bullish)" strokeWidth="1.5" strokeLinecap="round"
          />
          <path
        ...
        <p className="text-xs" style={{ color: 'var(--text-secondary)' }}>
          <span className="font-bold" style={{ color: 'var(--bullish)' }}>{stats.totalTrades}</span> trades clôturés
        </p>
      </div>
      ...
      <div className="rounded-2xl p-5 flex flex-col justify-between" style={{ background: '#0E1320' }}>
        <div className="flex items-center justify-between mb-3">
          ...
          <div
            ...
            style={{ border: '1.5px solid rgba(20,241,149,0.3)', color: 'var(--bullish)' }}
          >
            %
          </div>
        </div>
      ...
      <div className="rounded-2xl p-5 flex flex-col justify-between" style={{ background: '#0E1320' }}>
        ...
        <div>
          <div className="flex items-baseline gap-1 mb-1">
            <span className="font-data text-2xl font-bold" style={{ color: 'var(--bullish)' }}>
              +{stats.bestTradeFCFA.toLocaleString('fr-FR')}
            </span>
          </div>
          <p className="text-xs" style={{ color: 'var(--text-secondary)' }}>FCFA</p>
          <p
            className="text-xs font-semibold mt-2 font-data"
